...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("XnckDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["110.185.165.234"];
pub const RS_PUB_KEY: &str = "XP8xkXSZvqCWBP71bEkgNomPS9C5uxxaPRv6XG8xh7Y=";
